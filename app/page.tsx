      ...
      <main id="conteudo">
        <section className="hero evolved-hero wrap" aria-labelledby="hero-title">
          ...
          <div className="hero-art" aria-hidden="true">
            ...
            <div className="core"><Image src="/allm4-icon-v7.png" width={76} height={76} alt="" unoptimized /></div>
          ...
          <div className="product-stage" id="produto">
            ...
            <div className="floating-chip">
              <div className="chip-icon"><Image src="/allm4-icon-v7.png" width={38} height={38} alt="" unoptimized /></div>
